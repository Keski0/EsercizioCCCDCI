...
public class ContoDeposito extends Conto {
	...
	private final double tassoInteresseAnnuo = 0.1;
	private final double limitePrelievo = 1000;
	...
	public void preleva(double denaro) {
		if(denaro > limitePrelievo)
		{
			System.out.println("Non puoi ritirare questa somma di denaro!");
			errore = true;
		}
		else
		{
	...
	public double generaInteressi(LocalDate fineAnno, boolean primaVolta, double ultimoSaldo) {
		...
		logger.info(ContoDeposito.class.getName() + " - Interessi anno " + fineAnno.getYear());
