...
public class ContoInvestimento extends Conto {
	...
	public ContoInvestimento(String titolare, LocalDate dataApertura) {
		super(titolare, dataApertura);
		tassoInteresseAnnuo = Util.generaTassoInteresseAnnuo();
	}
	...
	public double generaInteressi(LocalDate fineAnno, boolean primaVolta, double ultimoSaldo) {
		...
		logger.info(ContoInvestimento.class.getName() + " - Interessi anno " + fineAnno.getYear());
